...
{
    public partial class CarInformationFormFive : Form
    {
        public CarInformationFormFive(string _carIds, bool carinfo)
        {
            ///carinfo为false： 卡
            if (carinfo == false)
            {
        ...
        public static CarInformationFormFive cinfo = null;
        ...
        private void CarInformationForm_Load(object sender, EventArgs e)
        {
            ...
            CommonalityEntity.isRestFXFive = false;
        ...
        private void CarInformationMethod()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(dt.Rows[0]["CarInfo_CarType_ID"].ToString()))
                {
        ...
        private void CarInformationForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                pictureBox2.Dispose();
                CommonalityEntity.isRestFXFive = false;
                CarInformationFormFive.cinfo = null;
        ...
        private void btn_ConfirmationRelease_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CommonalityEntity.isRestFXFive = true;
        ...
        private bool opDoorPort(int address)
        {
            ...
            CommonalityEntity.contolfive = contio;
        ...
        public void AddCarInOutInfoRecordMethod()
        {
            try
            {
                ...
                LinQBaseDao.InsertOne<CarInOutInfoRecord>(new DCCarManagementDataContext(), cioir);
