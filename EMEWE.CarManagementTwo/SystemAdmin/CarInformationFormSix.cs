...
{
    public partial class CarInformationFormSix : Form
    {
        public CarInformationFormSix(string _carIds, bool carinfo)
        {
            ///carinfo为false： 卡
            if (carinfo == false)
            {
        ...
        public static CarInformationFormSix cinfo = null;
        ...
        private void CarInformationForm_Load(object sender, EventArgs e)
        {
            ...
            CommonalityEntity.isRestFXSix = false;
        ...
        private void CarInformationForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                pictureBox2.Dispose();
                CommonalityEntity.isRestFXSix = false;
                CarInformationFormSix.cinfo = null;
        ...
        private void btn_ConfirmationRelease_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CommonalityEntity.isRestFXSix = true;
        ...
        private bool opDoorPort(int address)
        {
            ...
            CommonalityEntity.contolsix = contio;
        ...
        public void UpdateCarInOutRecordMethod(object inOut)
        {
            try
            {
                ...
                strsql = "select CarInOutRecord_ID,CarInfo_Name,CarType_Name,SmallTicket_Serialnumber,SortNumberInfo_TongXing from View_CarState where 1=1 and DATEDIFF(d, CarInOutRecord_Time, getdate())= 0 and(SortNumberInfo_TongXing = '已进厂')";
