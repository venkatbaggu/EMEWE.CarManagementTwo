...
{
    public partial class CarInformationFormFour : Form
    {
        public CarInformationFormFour(string _carIds, bool carinfo)
        {
            ///carinfo为false： 卡
            if (carinfo == false)
            {
        ...
        public static CarInformationFormFour cinfo = null;
        ...
        private void CarInformationForm_Load(object sender, EventArgs e)
        {
            ...
            CommonalityEntity.isRestFXFour = false;
        ...
        private void CarInformationMethod()
        {
            try
            {
                ...
                txt_EstablishTime.Text = dt.Rows[0]["CarInfo_Time"].ToString();//创建时间Carregistration_OperateTime
                txt_EstablishPeople.Text = dt.Rows[0]["CarInfo_Operate"].ToString();//创建人carregistration_recorder
        ...
        private void CarInformationForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                pictureBox2.Dispose();
                CommonalityEntity.isRestFXFour = false;
                CarInformationFormFour.cinfo = null;
        ...
        private void btn_ConfirmationRelease_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CommonalityEntity.isRestFXFour = true;
        ...
        private bool opDoorPort(int address)
        {
            ...
            CommonalityEntity.contolfour = contio;
        ...
        public void UpdateCarInOutRecordMethod(object inOut)
        {
            try
            {
                ...
                strsql = "select CarInOutRecord_ID,SmallTicket_Position_ID,SortNumberInfo_DrivewayValue,CarInfo_Name from View_CarState where 1=1 and DATEDIFF(d, CarInOutRecord_Time, getdate())= 0 and(SortNumberInfo_TongXing = '已进厂')";
        ...
        private void timer_CarIC_Tick(object sender, EventArgs e)
        {
